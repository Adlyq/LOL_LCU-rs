...
pub unsafe extern "system" fn tray_wnd_proc(hwnd: HWND, msg: u32, wparam: WPARAM, lparam: LPARAM) -> LRESULT {
    if msg == WM_TRAY_ICON {
...
pub unsafe fn show_tray_menu(tray_hwnd: HWND) {
...

    {
        ...
        add_check_item(ID_PREMADE_CHAMP, "选人阶段组队分析", config.premade_champ_select);
